...
curl -XPOST "http://localhost/api/queries/40/refresh?api_key=qsE6kWBu3lo9I91LNa4UGGAPPQLr9IYoNO4Ukqxq"
wget -q -O "担当地区別売上日報出力.xlsx" 'http://localhost/api/queries/40/results.xlsx?api_key=GrVOMaibBKP7YiYpM4qhXa8Wu1OYltWKsAfilMfj'
curl -XPOST "http://localhost/api/queries/3/refresh?api_key=qsE6kWBu3lo9I91LNa4UGGAPPQLr9IYoNO4Ukqxq"
wget -q -O "受注伝票枚数月別集計.xlsx" 'http://localhost/api/queries/3/results.xlsx?api_key=GdTbo83zTbMCqXpWWEOZyzALbzjtWKGhrSfcA0wB'
curl -XPOST "http://localhost/api/queries/42/refresh?api_key=qsE6kWBu3lo9I91LNa4UGGAPPQLr9IYoNO4Ukqxq"
